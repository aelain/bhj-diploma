...
Реализовать JavaScript-логику проекта (графический интерфейс и API).
...
Проверяющий эксперт (преподаватель): Владимир Чебукин

## Папка с выполненным заданием

[JS](https://github.com/aelain/bhj-diploma/tree/master/public/js)

## Описание (подробные требования к проекту)
